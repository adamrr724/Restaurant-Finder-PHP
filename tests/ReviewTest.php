<?php
    ...
    */
    ...
    class ReviewTest extends PHPUnit_Framework_TestCase
    {
        ...
        // {
        //     //Arrange
        //     $reviewer_name = "Bear Tooth";
        //     $id = 1;
        //     $review_score = "Spenard Road";
        //     $review_content = "$";
        //     $restaurant_id = 1;
        //
        //     $test_review = new Review($reviewer_name, $id, $review_score, $review_content, $restaurant_id);
        //
        //     $test_review->save();
        //
        //     $reviewer_name2 = "Organic Oasis";
        //     $id = 2;
        //     $review_score2 = "2606 Spenard Road";
        //     $review_content2 = "$$";
        //     $restaurant_id = 1;
        //
        //     $test_review2 = new Review($reviewer_name2, $id, $review_score2, $review_content2, $restaurant_id);
        //
        //     $test_review2->save();
        //
        //     //Act
